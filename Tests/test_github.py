...
def test_github(page: Page):
    ...
    page.locator(".l[href='https://github.com/login']").click()
    ...
    time.sleep(4)
    page.locator("div[class='monaco-icon-label folder-icon post_rolex_linkedin_play-name-dir-icon tests-name-folder-icon explorer-item monaco-decoration-itemColor-eazkc8 monaco-decoration-bubbleBadge-eazkc8 monaco-decoration-iconBadge-eazkc8'] div[class='monaco-icon-label-container']").click()
    page.locator("div[id='list_id_2_7'] div[class='monaco-tl-row']").click()
    page.locator(".view-lines.monaco-mouse-cursor-text").click()
